import{v as X,w as st,b as I,q as nt}from"./index-lVgvYSiE.js";import{c as pt}from"./flagHelper-DudXahMb.js";import{n as D,M as K}from"./categoryHelper-TmElMUWB.js";const e=t=>String(t??"—").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]),Z=t=>t?new Date(t).toLocaleString():"—";function lt(t,r=""){let s=String(t.flag||"").trim().toUpperCase();return!s&&t.result&&t.referenceValue&&(s=pt(t.result,t.referenceValue,r)),["CH","CRITICAL HIGH","CRITICAL_HIGH"].includes(s)?"CH":["CL","CRITICAL LOW","CRITICAL_LOW"].includes(s)?"CL":s==="H"||s==="HIGH"?"H":s==="L"||s==="LOW"?"L":s==="N"||s==="NORMAL"?"Normal":"—"}function P(t){if(!t)return"—";if(typeof t=="string"){const o=t.trim();if(/^\d{4}-\d{2}-\d{2}/.test(o)){const[p,v,b]=o.slice(0,10).split("-"),N=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][parseInt(v,10)-1]||v;return`${b.padStart(2,"0")} ${N} ${p}`}}const r=new Date(t);if(isNaN(r.getTime()))return String(t);const s=String(r.getUTCDate?r.getUTCDate():r.getDate()).padStart(2,"0"),z=r.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),h=r.getUTCFullYear?r.getUTCFullYear():r.getFullYear();return`${s} ${z} ${h}`}function xt(t,r,s,z,h){var M,H,F,U,j,G,O,V,_,Y,q,W;const o=t!=null&&t.patient&&typeof t.patient=="object"?t.patient:t||{},p=(t==null?void 0:t.testType)||(t==null?void 0:t.docType)==="PathologyCase"||!!((M=t==null?void 0:t.structuredReport)!=null&&M.grossDescription||(H=t==null?void 0:t.structuredReport)!=null&&H.cytologicalFindings||(F=t==null?void 0:t.structuredReport)!=null&&F.rbcMorphology),v=(t==null?void 0:t.examinationType)||(t==null?void 0:t.docType)==="RadiologyCase"||!!((U=t==null?void 0:t.structuredReport)!=null&&U.liver||(j=t==null?void 0:t.structuredReport)!=null&&j.findings),b=(t==null?void 0:t.isInternalMedicineForm)===!0||(o==null?void 0:o.examinationFormType)==="Internal Medicine Speciality Examination Form",u=h!==void 0?h:t.showFooter!==void 0?t.showFooter:!0,N=s||nt,Q=u&&N?`<img src="${N}" alt="ETU Diagnostic Laboratory Logo" style="max-height: 80px; width: auto; max-width: 100%; display: block; margin: 0 auto 6px; object-fit: contain;" />`:"",tt=o.referralHospital?`<div><b>Referral Hospital Name</b>${e(o.referralHospital)}</div><div><b>Referral Hospital Address</b>${e(z||o.address||"Not recorded")}</div>`:"",et=o.systolicBP||o.diastolicBP?`<div><b>Blood Pressure</b>${e(o.systolicBP||"—")}/${e(o.diastolicBP||"—")} mmHg</div>`:"",ot=(o.sampleTypes||[]).map(a=>(a==null?void 0:a.name)||a).filter(Boolean).join(", ")||(p?"Pathology Specimen":v?"Imaging Scan":"Specimen Assigned"),it=Z(o.collectionDate||o.registrationDate||o.createdDate||t.createdDate),B=Z(t.approvedAt||t.approvedDate||t.approvalDate||t.updatedDate||new Date);let k="",T=b?"Internal Medicine Speciality Examination Form":"Official Laboratory Test Report",L=e(((G=t.technician)==null?void 0:G.fullName)||((O=t.submittedBy)==null?void 0:O.fullName)||(r==null?void 0:r.fullName)||"Clinical Specialist");const R=((V=t.approvedBy)==null?void 0:V.fullName)||((_=t.pathologist)==null?void 0:_.fullName)||((Y=t.radiologist)==null?void 0:Y.fullName)||((W=(q=t.internalMedicineReport)==null?void 0:q.declaration)==null?void 0:W.doctorName)||(["Approved","Ready for Printing"].includes(t.status)?r==null?void 0:r.fullName:"");let E=e(R?R.startsWith("Dr.")?R:`Dr. ${R}`:"Pending Specialist Approval"),C=t.approverRole||(p?"Pathologist":v?"Radiologist":b?"Authorized Medical Doctor":"Approver / Laboratory Technologist");if(b){const a=t.internalMedicineReport||{},i=a.labInvestigations||{},l=a.clinicalExamination||{},g=a.vitalSigns||{},$=a.declaration||{};k=`
    ...
    `}else if(p)if(T=`Pathology Examination Report — ${e(t.testType||"Biopsy")}`,C="Pathologist",t.reportType==="Option A"||!t.reportType&&t.reportContent)k=`
      ...
      `}else if(v)if(T=`Radiology & Imaging Report — ${e(t.customExaminationName||(t.ultrasoundSubtype?`Ultrasound — ${t.ultrasoundSubtype}`:t.examinationType||"Diagnostic Imaging"))}`,C="Radiologist",t.reportType==="Option A"||!t.reportType&&t.reportContent)k=`
        <section class="section">
    ...
    <section class="section" style="margin-top: ${b?"6px":"8px"};">
      ...
      `:`
        <div class="patient">
          ...
          <div><b>Examination Type</b>${e(t.testType||t.customExaminationName||t.ultrasoundSubtype||t.examinationType||ot)}</div>
          <div><b>Registration Date</b>${e(it)}</div>
...
</html>`}async function ft(t,r,s,z){typeof r!="string"&&(s=r||s||X(),r=st()),s||(s=X());const h=typeof t=="string"?t:t==null?void 0:t._id;if(!h)throw new Error("The requested document could not be loaded.");const o=window.open("","_blank","width=980,height=900");if(!o)throw new Error("Print preview was blocked. Please allow pop-ups and try again.");try{let p=typeof t=="object"?t:null,v="",b="";if(!p||!p.patient)try{const u=await I(`/final-reports/${h}`,{token:r});p=u.report,v=u.logoBase64,b=u.referralHospitalAddress}catch{try{p=(await I(`/pathology/cases/${h}`,{token:r})).case}catch{p=(await I(`/radiology/cases/${h}`,{token:r})).case}}o.document.write(xt(p,s,v,b,z)),o.document.close()}catch(p){throw o.close(),new Error(p.message||"The requested document could not be loaded.")}}export{ft as p};
