import{v as E,w as G,b as O,q as bt}from"./index-ChXVfvON.js";import{c as xt}from"./flagHelper-Bt44hAxk.js";import{n as H,M as dt}from"./categoryHelper-DRBJIStQ.js";import{f as gt,l as mt,c as ft}from"./etu_cli-W_0ukhbz.js";const e=t=>String(t??"—").replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n]),nt=t=>t?new Date(t).toLocaleString():"—";function yt(t,n=""){let d=String(t.flag||"").trim().toUpperCase();return!d&&t.result&&t.referenceValue&&(d=xt(t.result,t.referenceValue,n)),["CH","CRITICAL HIGH","CRITICAL_HIGH"].includes(d)?"CH":["CL","CRITICAL LOW","CRITICAL_LOW"].includes(d)?"CL":d==="H"||d==="HIGH"?"H":d==="L"||d==="LOW"?"L":d==="N"||d==="NORMAL"?"Normal":"—"}function V(t){if(!t)return"—";if(typeof t=="string"){const l=t.trim();if(/^\d{4}-\d{2}-\d{2}/.test(l)){const[o,f,y]=l.slice(0,10).split("-"),s=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][parseInt(f,10)-1]||f;return`${y.padStart(2,"0")} ${s} ${o}`}}const n=new Date(t);if(isNaN(n.getTime()))return String(t);const d=String(n.getUTCDate?n.getUTCDate():n.getDate()).padStart(2,"0"),x=n.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),w=n.getUTCFullYear?n.getUTCFullYear():n.getFullYear();return`${d} ${x} ${w}`}function ht(t,n,d,x,w,l){var W,J,X,K,Z,Q,tt,et,ot,it,at;const o=t!=null&&t.patient&&typeof t.patient=="object"?t.patient:t||{},f=(t==null?void 0:t.testType)||(t==null?void 0:t.docType)==="PathologyCase"||!!((W=t==null?void 0:t.structuredReport)!=null&&W.grossDescription||(J=t==null?void 0:t.structuredReport)!=null&&J.cytologicalFindings||(X=t==null?void 0:t.structuredReport)!=null&&X.rbcMorphology),y=(t==null?void 0:t.examinationType)||(t==null?void 0:t.docType)==="RadiologyCase"||!!((K=t==null?void 0:t.structuredReport)!=null&&K.liver||(Z=t==null?void 0:t.structuredReport)!=null&&Z.findings),b=(t==null?void 0:t.isInternalMedicineForm)===!0||(o==null?void 0:o.examinationFormType)==="Internal Medicine Speciality Examination Form",s=w!==void 0?w:t.showFooter!==void 0?t.showFooter:!0,P=l!==void 0?l:t==null?void 0:t.stampType,z=P==="lab"?mt:P==="clinic"?ft:null,L=P==="clinic"?"ETU Clinic Stamp":"ETU Lab Stamp",c=z?`<div class="report-stamp-container" style="position: absolute; right: 8px; top: -18px; pointer-events: none; z-index: 2;"><img src="${z}" alt="${L}" style="width: 114px; height: 114px; object-fit: contain; display: block;" /></div>`:"",C=d||bt,N=s&&C?`<img src="${C}" alt="ETU Diagnostic Laboratory Logo" style="width: 100%; height: auto; max-height: none; display: block; margin: 0; padding: 0; object-fit: contain;" />`:"",A=o.referralHospital?`<div><b>Referral Hospital Name:</b> <span>${e(o.referralHospital)}</span></div><div><b>Referral Hospital Address:</b> <span>${e(x||o.address||"Not recorded")}</span></div>`:"",B=o.systolicBP||o.diastolicBP?`<div><b>Blood Pressure:</b> <span>${e(o.systolicBP||"—")}/${e(o.diastolicBP||"—")} mmHg</span></div>`:"",T=nt(o.collectionDate||o.registrationDate||o.createdDate||t.createdDate),Y=nt(t.approvedAt||t.approvedDate||t.approvalDate||t.updatedDate||new Date);let D="",j=b?"Internal Medicine Speciality Examination Form":"Official Laboratory Test Report",F=e(((Q=t.technician)==null?void 0:Q.fullName)||((tt=t.submittedBy)==null?void 0:tt.fullName)||(n==null?void 0:n.fullName)||"Clinical Specialist");const I=t.approvedBy||(["Approved","Ready for Printing"].includes(t.status)?n:null),st=(I==null?void 0:I.fullName)||(typeof t.approvedBy=="string"?t.approvedBy:"")||((et=t.pathologist)==null?void 0:et.fullName)||((ot=t.radiologist)==null?void 0:ot.fullName)||((at=(it=t.internalMedicineReport)==null?void 0:it.declaration)==null?void 0:at.doctorName)||"",pt=(I==null?void 0:I.role)||t.approverRole||"";let q=e(gt(st,pt)),U=f?"Pathologist":y?"Radiologist":b?"Authorized Medical Doctor":t.approverRole&&t.approverRole!=="Approver"&&t.approverRole!=="Approver / Laboratory Technologist"?t.approverRole:"head of etu diagnostic laboratory";if(b){const r=t.internalMedicineReport||{},i=r.labInvestigations||{},g=r.clinicalExamination||{},u=r.vitalSigns||{},S=r.declaration||{};D=`
        ...
        <div class="imed-a4-decl-box" style="border: 1.5px solid #000; margin-bottom: 6px; width: 100%; max-width: 100%; box-sizing: border-box;">
          ...
          <div class="imed-a4-decl-body" style="padding: 5px 8px; font-size: 10.5px; box-sizing: border-box;">
            ...
            <div class="imed-a4-decl-grid" style="display: grid; grid-template-columns: 1.2fr 1fr 1fr; gap: 8px; padding-top: 3px; border-top: 1px dashed #718096; position: relative;">
              <div><b>Doctor Name:</b> <strong>${e(S.doctorName||q||F)}</strong></div>
              <div><b>Signature:</b> <span style="display: inline-block; min-width: 90px; border-bottom: 1px solid #000;">&nbsp;</span></div>
              <div><b>Date:</b> <span>${e(V(S.signatureDate||new Date))}</span></div>
              ${z?`<div class="report-stamp-container" style="position: absolute; right: 10px; top: -18px; pointer-events: none; z-index: 2;"><img src="${z}" alt="${L}" style="width: 108px; height: 108px; object-fit: contain; display: block;" /></div>`:""}
            </div>
          </div>
        </div>
      </div>
    `}else if(f)if(j=`Pathology Examination Report — ${e(t.testType||"Biopsy")}`,U="Pathologist",t.reportType==="Option A"||!t.reportType&&t.reportContent)D=`
      ...
      `}else if(y)if(j=`Radiology & Imaging Report — ${e(t.customExaminationName||(t.ultrasoundSubtype?`Ultrasound — ${t.ultrasoundSubtype}`:t.examinationType||"Diagnostic Imaging"))}`,U="Radiologist",t.reportType==="Option A"||!t.reportType&&t.reportContent)D=`
        <section class="section">
      ...
      `}else{const r=t.results||[],i={},g={};(Array.isArray(t==null?void 0:t.laboratoryTests)?t.laboratoryTests:Array.isArray(o==null?void 0:o.laboratoryTests)?o.laboratoryTests:[]).forEach(a=>{var M,k;if(!a||typeof a!="object")return;const h=a.category?typeof a.category=="object"?a.category.name||"":String(a.category):"",m=Array.isArray(a.parameters)&&a.parameters.length>0?typeof a.parameters[0]=="string"?a.parameters[0]:((M=a.parameters[0])==null?void 0:M.name)||((k=a.parameters[0])==null?void 0:k.sampleName):a.name,p=H(h,m||a.name),v=a.subcategory||"";Array.isArray(a.parameters)&&a.parameters.forEach($=>{const _=typeof $=="string"?$:($==null?void 0:$.name)||($==null?void 0:$.sampleName)||"";_&&(i[_]=p,v&&(g[_]=v.toUpperCase()))}),a.name&&(i[a.name]=p,v&&(g[a.name]=v.toUpperCase()))});const S=new Map;r.forEach(a=>{const h=H(a.category||i[a.sampleName],a.sampleName),m=(a.subcategory||g[a.sampleName]||"").toUpperCase();S.has(h)||S.set(h,new Map);const p=S.get(h),v=m||"GENERAL";p.has(v)||p.set(v,[]),p.get(v).push(a)});const rt=Array.from(S.entries()).sort(([a],[h])=>{const m=dt.indexOf(a),p=dt.indexOf(h);return m!==-1&&p!==-1?m-p:m!==-1?-1:p!==-1?1:a.localeCompare(h)}),lt=Array.isArray(t.testInterpretations)?t.testInterpretations:[],ct=a=>{const h=H(a),m=lt.find(p=>H(p.testName)===h);return(m==null?void 0:m.interpretations)||[]};let R="";rt.length>0?rt.forEach(([a,h])=>{R+=`<div class="result-cat-block" style="margin-bottom: 22px;"><h4 class="result-cat-header">${e(a)}</h4>`,h.forEach((p,v)=>{v!=="GENERAL"&&(R+=`<h5 style="margin: 6px 0 4px 0; font-size: 11px; text-transform: uppercase; color: #075c91; background: #e8f5fa; padding: 3px 8px; border-radius: 4px; display: inline-block;">${e(v)}</h5>`);const M=p.map(k=>{const $=yt(k,o.sex);return`<tr><td><b>${e(k.sampleName)}</b>${k.remarks?`<small>${e(k.remarks)}</small>`:""}</td><td>${e(k.result)}</td><td>${e(k.unit)}</td><td>${e(k.referenceValue)}</td><td><b>${e($)}</b></td></tr>`}).join("");R+=`<table style="margin-bottom: 6px;"><thead><tr><th>Test / Parameter</th><th>Result</th><th>SI Unit</th><th>Reference Range</th><th>Flag</th></tr></thead><tbody>${M}</tbody></table>`});const m=ct(a);m.length>0&&(R+='<div style="margin: 6px 0 14px 0; padding: 8px 12px; background: #f0f7fa; border-left: 4px solid #075c91; border-radius: 4px;"><b style="color: #075c91; font-size: 11px; text-transform: uppercase;">Clinical Interpretation:</b>',m.forEach(p=>{R+=`<div style="margin-top: 4px; font-size: 11px; color: #203640;"><b>${e(p.title)}:</b> ${e(p.interpretation)}</div>`}),R+="</div>"),R+="</div>"}):R='<table><thead><tr><th>Test / Parameter</th><th>Result</th><th>SI Unit</th><th>Reference Range</th><th>Flag</th></tr></thead><tbody><tr><td colspan="5">No laboratory results recorded.</td></tr></tbody></table>',D=`
      <section class="section">
    ...
    <section class="section" style="margin-top: ${b?"6px":s?"8px":"0px"};">
          ...
          <table class="imed-a4-table-bordered" style="flex: 1; min-width: 0; width: 100%; max-width: 100%; table-layout: fixed; border-collapse: collapse; border: 1.5px solid #000; font-size: 10.5px; box-sizing: border-box;">
            <tbody>
              ...
              <tr>
                ...
                <td style="border: 1px solid #000; padding: 3px 5px;">${e(V(o.dateOfBirth||o.dob||o.birthDate||t.dateOfBirth||t.dob||t.birthDate))}</td>
              ...
              <tr>
                ...
                <td style="border: 1px solid #000; padding: 3px 5px;">${e(V(o.passportIssueDate||o.passportIssue||o.passport_issue_date||t.passportIssueDate||t.passportIssue||t.passport_issue_date))}</td>
              </tr>
              <tr>
      ...
      `:`
        <div class="patient">
          ...
          <div><b>Report Date:</b> <span>${e(Y)}</span></div>
      ...
      <section class="section">
        ...
        <div class="signoff-grid" style="position: relative;">
          <div>
            ...
            <b>Prepared By:</b> <strong>${F}</strong>
          </div>
          <div><b>Approved By:</b> <strong>${q}</strong> <span style="font-size: 10.5px; color: #64748b;">(${e(U)})</span></div>
          <div><b>Approval Date:</b> <strong>${e(Y)}</strong></div>
          ${c}
        </div>
      </section>
    `:!b&&!s&&z?`
      <div class="report-stamp-standalone-container" style="display: flex; justify-content: flex-end; margin-top: 16px; margin-bottom: 8px; padding-right: 12px; position: relative; pointer-events: none; z-index: 2;">
        <img src="${z}" alt="${L}" style="width: 114px; height: 114px; object-fit: contain; display: block;" />
      </div>
    `:""}

    ${s?`
      <footer class="${b?"imed-a4-footer":"footer"}">
        <span>Title: Head of ETU Diagnostic Laboratory &bull; Prepared By: ${F}</span>
        <span class="report-preview-footer-brand">ETU DIAGNOSTIC LABORATORY</span>
      </footer>
    `:""}
  </main>
</body>
</html>`}async function $t(t,n,d,x,w){let l=null,o=null,f,y;typeof n=="string"?(l=n,o=d,f=x,y=w):typeof n=="boolean"?(f=n,l=E(),o=G(),y=typeof d=="string"?d:typeof x=="string"?x:w):typeof n=="object"&&n!==null?(o=n,typeof d=="boolean"?(f=d,l=E(),y=x):typeof d=="string"?(l=d,f=x,y=w):(l=E(),f=x!==void 0?x:typeof d=="boolean"?d:void 0,y=w)):(l=E(),o=G(),f=n!==void 0?n:d!==void 0?d:x,y=typeof d=="string"?d:typeof x=="string"?x:w),l||(l=E()),o||(o=G());const b=typeof t=="string"?t:t==null?void 0:t._id;if(!b)throw new Error("The requested document could not be loaded.");let s=typeof t=="object"?t:null,P="",z="";if(!s||!s.patient)try{const N=await O(`/final-reports/${b}`,{token:l});s=N.report,P=N.logoBase64,z=N.referralHospitalAddress}catch{try{s=(await O(`/pathology/cases/${b}`,{token:l})).case}catch{s=(await O(`/radiology/cases/${b}`,{token:l})).case}}if(!s)throw new Error("The requested document could not be loaded.");const L=ht(s,o,P,z,f,y);let c=document.getElementById("a4-lab-report-print-frame");if(c)try{c.remove()}catch{}c=document.createElement("iframe"),c.id="a4-lab-report-print-frame",c.style.position="fixed",c.style.right="0",c.style.bottom="0",c.style.width="0px",c.style.height="0px",c.style.border="none",document.body.appendChild(c);const C=c.contentWindow.document;return C.open(),C.write(L),C.close(),new Promise(N=>{let A=!1;const B=()=>{if(!A){A=!0;try{const T=c.contentWindow;T&&!T.__hasPrinted&&(T.__hasPrinted=!0,T.focus(),T.print())}catch(T){console.warn("Iframe print error:",T)}N()}};c.onload=()=>setTimeout(B,200),setTimeout(B,600)})}export{$t as p};
