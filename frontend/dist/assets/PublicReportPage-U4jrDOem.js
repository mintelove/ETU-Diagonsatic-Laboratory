import{p as J,r as d,j as e,q as Q,i as Z}from"./index-DghZSOWW.js";import{F as K}from"./flagHelper-CVm49PbE.js";import{n as h,M as W}from"./categoryHelper-DRBJIStQ.js";import{l as ee,c as te,f as I}from"./etu_cli-BwHrebo7.js";function ne(){var R,A,B,E,D,L;const{token:f}=J(),[r,C]=d.useState(null),[P,u]=d.useState(!0),[c,x]=d.useState(""),[y,S]=d.useState(!1);d.useLayoutEffect(()=>{const t=document.body.style.backgroundColor,i=document.documentElement.getAttribute("data-theme"),o=document.body.className;return document.body.style.backgroundColor="#f1f3f5",document.documentElement.setAttribute("data-theme","light"),document.documentElement.classList.remove("dark"),document.body.classList.remove("dark"),()=>{document.body.style.backgroundColor=t,i?document.documentElement.setAttribute("data-theme",i):document.documentElement.removeAttribute("data-theme"),document.body.className=o}},[]),d.useEffect(()=>{async function t(){if(!f){x("Report not found."),u(!1);return}try{u(!0),x("");const i="http://localhost:5000/api".replace(/\/+$/,"");let o=await fetch(`${i}/reports/public/${f}`);if(o.status===404){const l=await fetch(`${i}/public/reports/${f}`);l.ok&&(o=l)}const a=await o.json();if(!o.ok)throw o.status===404?new Error("Report not found."):o.status===403?new Error(a.message||"This report is not available for public viewing."):new Error(a.message||"Unable to load report. Please try again.");C(a.report)}catch(i){Z(i)?x(""):x(i.message||"Unable to load report.")}finally{u(!1)}}t()},[f]);const U=()=>{const t=window.location.href;navigator.clipboard.writeText(t),S(!0),setTimeout(()=>S(!1),3e3)},F=()=>{const t="http://localhost:5000/api".replace(/\/+$/,"");window.open(`${t}/reports/public/${f}/pdf`,"_blank")};if(P)return e.jsx("div",{style:{minHeight:"100vh",height:"auto",display:"flex",alignItems:"center",justifyContent:"center",background:"#f1f3f5",color:"#0f172a",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',padding:"16px",boxSizing:"border-box"},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{width:"48px",height:"48px",margin:"0 auto 16px",border:"4px solid #e2e8f0",borderTopColor:"#075c91",borderRadius:"50%",animation:"spin 1s linear infinite"}}),e.jsx("h2",{style:{fontSize:"1.1rem",color:"#0f172a",fontWeight:700,margin:"0 0 4px 0"},children:"Processing..."}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.85rem",margin:0},children:"Loading official diagnostic report…"})]})});if(c||!r)return e.jsx("div",{style:{minHeight:"100vh",height:"auto",display:"flex",alignItems:"center",justifyContent:"center",background:"#f1f3f5",color:"#0f172a",padding:"20px",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',boxSizing:"border-box"},children:e.jsxs("div",{style:{maxWidth:"480px",width:"100%",background:"#ffffff",borderRadius:"16px",padding:"32px 24px",boxShadow:"0 10px 25px -5px rgba(0,0,0,0.05)",textAlign:"center",border:"1px solid #cbd5e1",boxSizing:"border-box"},children:[e.jsx("div",{style:{width:"56px",height:"56px",borderRadius:"50%",background:c.includes("not available")?"#fef3c7":"#fef2f2",color:c.includes("not available")?"#d97706":"#ef4444",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px",margin:"0 auto 16px"},children:c.includes("not available")?"🔒":"⚠️"}),e.jsx("h2",{style:{fontSize:"1.25rem",color:"#0f172a",marginBottom:"8px",fontWeight:700},children:c||"Unable to load report. Please try again."}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.9rem",lineHeight:"1.5",marginBottom:"24px"},children:c.includes("not available")?"This report has not completed final administrative approval or sharing is disabled.":c.includes("not found")?"The requested report token is invalid or has been removed.":"Please check your connection or contact ETU Diagnostic Laboratory support."}),e.jsx("div",{style:{padding:"12px",background:"#f1f5f9",borderRadius:"8px",fontSize:"0.8rem",color:"#475569"},children:"🔒 ETU Diagnostic Laboratory — Official Results Portal"})]})});const n=r.patient||{},O=r.patientName||n.name||"—",H=r.patientId||n.patientId||"—",M=r.age||n.age||"—",w=r.sex||n.sex||"—",G=n.phone||"—",$=(n.sampleTypes||[]).map(t=>(t==null?void 0:t.name)||t).filter(Boolean).join(", ")||"Specimen Assigned",V=n.collectionDate||n.createdDate||r.createdDate?new Date(n.collectionDate||n.createdDate||r.createdDate).toLocaleString():"—",T=r.approvedDate||r.approvalDate||r.reportDate?new Date(r.approvedDate||r.approvalDate||r.reportDate).toLocaleString():new Date().toLocaleString(),X=r.results||[],Y=Array.isArray(r==null?void 0:r.laboratoryTests)?r.laboratoryTests:Array.isArray(n==null?void 0:n.laboratoryTests)?n.laboratoryTests:r.tests||[],j={},v={};Y.forEach(t=>{var m,b;if(!t||typeof t!="object")return;const i=t.category?typeof t.category=="object"?t.category.name||"":String(t.category):t.categoryName||"",o=Array.isArray(t.parameters)&&t.parameters.length>0?typeof t.parameters[0]=="string"?t.parameters[0]:((m=t.parameters[0])==null?void 0:m.name)||((b=t.parameters[0])==null?void 0:b.sampleName):t.testName||t.name,a=h(i,o||t.testName||t.name),l=t.subcategory||"";Array.isArray(t.parameters)&&t.parameters.forEach(p=>{const k=typeof p=="string"?p:(p==null?void 0:p.name)||(p==null?void 0:p.sampleName)||"";k&&(j[k]=a,l&&(v[k]=l.toUpperCase()))});const s=t.testName||t.name||"";s&&(j[s]=a,l&&(v[s]=l.toUpperCase()))});const g=new Map;X.forEach(t=>{const i=t.parameter||t.sampleName||t.name||"",o=h(t.category||j[i],i),a=(t.subcategory||v[i]||"").toUpperCase();g.has(o)||g.set(o,new Map);const l=g.get(o),s=a||"GENERAL";l.has(s)||l.set(s,[]),l.get(s).push(t)});const z=Array.from(g.entries()).sort(([t],[i])=>{const o=W.indexOf(t),a=W.indexOf(i);return o!==-1&&a!==-1?o-a:o!==-1?-1:a!==-1?1:t.localeCompare(i)}),_=Array.isArray(r.testInterpretations)?r.testInterpretations:[],q=t=>{const i=h(t),o=_.find(a=>h(a.testName)===i);return(o==null?void 0:o.interpretations)||[]},N=r.stampType==="lab"?ee:r.stampType==="clinic"?te:null;return e.jsxs("div",{className:"public-report-page",style:{minHeight:"100vh",height:"auto",width:"100%",background:"#f1f3f5",color:"#0f172a",padding:"24px 16px",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',boxSizing:"border-box",overflowX:"hidden",overflowY:"visible",WebkitOverflowScrolling:"touch"},children:[e.jsx("style",{children:`
        :root, html, body {
