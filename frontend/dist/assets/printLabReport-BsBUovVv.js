import{s as Z,t as lt,b as P,o as pt}from"./index-BGMN4Fif.js";import{c as xt}from"./flagHelper-BkH69K0p.js";import{n as D,M as Q}from"./categoryHelper-BfLcvrSf.js";const e=t=>String(t??"—").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]),tt=t=>t?new Date(t).toLocaleString():"—";function bt(t,r=""){let s=String(t.flag||"").trim().toUpperCase();return!s&&t.result&&t.referenceValue&&(s=xt(t.result,t.referenceValue,r)),["CH","CRITICAL HIGH","CRITICAL_HIGH"].includes(s)?"CH":["CL","CRITICAL LOW","CRITICAL_LOW"].includes(s)?"CL":s==="H"||s==="HIGH"?"H":s==="L"||s==="LOW"?"L":s==="N"||s==="NORMAL"?"Normal":"—"}function I(t){if(!t)return"—";if(typeof t=="string"){const o=t.trim();if(/^\d{4}-\d{2}-\d{2}/.test(o)){const[l,v,c]=o.slice(0,10).split("-"),N=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][parseInt(v,10)-1]||v;return`${c.padStart(2,"0")} ${N} ${l}`}}const r=new Date(t);if(isNaN(r.getTime()))return String(t);const s=String(r.getUTCDate?r.getUTCDate():r.getDate()).padStart(2,"0"),z=r.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),h=r.getUTCFullYear?r.getUTCFullYear():r.getFullYear();return`${s} ${z} ${h}`}function ct(t,r,s,z,h){var M,H,F,U,j,G,O,V,_,Y,q,W,J,X;const o=t!=null&&t.patient&&typeof t.patient=="object"?t.patient:t||{},l=(t==null?void 0:t.testType)||(t==null?void 0:t.docType)==="PathologyCase"||!!((M=t==null?void 0:t.structuredReport)!=null&&M.grossDescription||(H=t==null?void 0:t.structuredReport)!=null&&H.cytologicalFindings||(F=t==null?void 0:t.structuredReport)!=null&&F.rbcMorphology),v=(t==null?void 0:t.examinationType)||(t==null?void 0:t.docType)==="RadiologyCase"||!!((U=t==null?void 0:t.structuredReport)!=null&&U.liver||(j=t==null?void 0:t.structuredReport)!=null&&j.findings),c=(t==null?void 0:t.isInternalMedicineForm)||!!((G=t==null?void 0:t.internalMedicineReport)!=null&&G.examinationResult||(O=t==null?void 0:t.internalMedicineReport)!=null&&O.labInvestigations)||(o==null?void 0:o.examinationFormType)==="Internal Medicine Speciality Examination Form"||Array.isArray(t==null?void 0:t.laboratoryTests)&&t.laboratoryTests.some(i=>/internal medicine/i.test((i==null?void 0:i.name)||i))||Array.isArray(o==null?void 0:o.laboratoryTests)&&o.laboratoryTests.some(i=>/internal medicine/i.test((i==null?void 0:i.name)||i)),u=h!==void 0?h:t.showFooter!==void 0?t.showFooter:!0,N=s||pt,et=u&&N?`<img src="${N}" alt="ETU Diagnostic Laboratory Logo" style="max-height: 80px; width: auto; max-width: 100%; display: block; margin: 0 auto 6px; object-fit: contain;" />`:"",ot=o.referralHospital?`<div><b>Referral Hospital Name</b>${e(o.referralHospital)}</div><div><b>Referral Hospital Address</b>${e(z||o.address||"Not recorded")}</div>`:"",it=o.systolicBP||o.diastolicBP?`<div><b>Blood Pressure</b>${e(o.systolicBP||"—")}/${e(o.diastolicBP||"—")} mmHg</div>`:"",at=(o.sampleTypes||[]).map(i=>(i==null?void 0:i.name)||i).filter(Boolean).join(", ")||(l?"Pathology Specimen":v?"Imaging Scan":"Specimen Assigned"),dt=tt(o.collectionDate||o.registrationDate||o.createdDate||t.createdDate),B=tt(t.approvedAt||t.approvedDate||t.approvalDate||t.updatedDate||new Date);let k="",T=c?"Internal Medicine Speciality Examination Form":"Official Laboratory Test Report",L=e(((V=t.technician)==null?void 0:V.fullName)||((_=t.submittedBy)==null?void 0:_.fullName)||(r==null?void 0:r.fullName)||"Clinical Specialist");const R=((Y=t.approvedBy)==null?void 0:Y.fullName)||((q=t.pathologist)==null?void 0:q.fullName)||((W=t.radiologist)==null?void 0:W.fullName)||((X=(J=t.internalMedicineReport)==null?void 0:J.declaration)==null?void 0:X.doctorName)||(["Approved","Ready for Printing"].includes(t.status)?r==null?void 0:r.fullName:"");let E=e(R?R.startsWith("Dr.")?R:`Dr. ${R}`:"Pending Specialist Approval"),A=t.approverRole||(l?"Pathologist":v?"Radiologist":c?"Authorized Medical Doctor":"Approver / Laboratory Technologist");if(c){const i=t.internalMedicineReport||{},a=i.labInvestigations||{},p=i.clinicalExamination||{},g=i.vitalSigns||{},$=i.declaration||{};k=`
        ...
        <div class="imed-a4-decl-box" style="border: 1.5px solid #000; margin-bottom: 6px; width: 100%; max-width: 100%; box-sizing: border-box;">
          ...
          <div class="imed-a4-decl-body" style="padding: 5px 8px; font-size: 10.5px; box-sizing: border-box;">
            ...
            <div class="imed-a4-decl-grid" style="display: grid; grid-template-columns: 1.2fr 1fr 1fr; gap: 8px; padding-top: 3px; border-top: 1px dashed #718096;">
              ...
              <div><b>Date:</b> <span>${e(I($.signatureDate||new Date))}</span></div>
            </div>
          </div>
        </div>
      </div>
...
<body>
  ...
  <main class="page">
    ...
    <section class="section" style="margin-top: ${c?"6px":"8px"};">
          ...
          <table class="imed-a4-table-bordered" style="flex: 1; min-width: 0; width: 100%; max-width: 100%; table-layout: fixed; border-collapse: collapse; border: 1.5px solid #000; font-size: 10.5px; box-sizing: border-box;">
            <tbody>
              ...
              <tr>
                ...
                <td style="border: 1px solid #000; padding: 3px 5px;">${e(I(o.dateOfBirth||o.dob||o.birthDate||t.dateOfBirth||t.dob||t.birthDate))}</td>
              ...
              <tr>
                ...
                <td style="border: 1px solid #000; padding: 3px 5px;">${e(I(o.passportIssueDate||o.passportIssue||o.passport_issue_date||t.passportIssueDate||t.passportIssue||t.passport_issue_date))}</td>
              </tr>
              <tr>
...
</html>`}async function yt(t,r,s,z){typeof r!="string"&&(s=r||s||Z(),r=lt()),s||(s=Z());const h=typeof t=="string"?t:t==null?void 0:t._id;if(!h)throw new Error("The requested document could not be loaded.");const o=window.open("","_blank","width=980,height=900");if(!o)throw new Error("Print preview was blocked. Please allow pop-ups and try again.");try{let l=typeof t=="object"?t:null,v="",c="";if(!l||!l.patient)try{const u=await P(`/final-reports/${h}`,{token:r});l=u.report,v=u.logoBase64,c=u.referralHospitalAddress}catch{try{l=(await P(`/pathology/cases/${h}`,{token:r})).case}catch{l=(await P(`/radiology/cases/${h}`,{token:r})).case}}o.document.write(ct(l,s,v,c,z)),o.document.close()}catch(l){throw o.close(),new Error(l.message||"The requested document could not be loaded.")}}export{yt as p};
