import{p as K,k as ee,r as d,j as e,q as te,i as re}from"./index-t9SmL2MC.js";import{F as oe}from"./flagHelper-BXvgr0nL.js";import{n as u,M as C}from"./categoryHelper-DRBJIStQ.js";import{l as ae,c as ie,f as P}from"./etu_cli-BwHrebo7.js";function de(){var B,E,D,W,I,L;const{token:f}=K(),[w]=ee(),[r,U]=d.useState(null),[F,y]=d.useState(!0),[c,g]=d.useState(""),[j,T]=d.useState(!1);d.useLayoutEffect(()=>{const t=document.body.style.backgroundColor,a=document.documentElement.getAttribute("data-theme"),o=document.body.className;return document.body.style.backgroundColor="#f1f3f5",document.documentElement.setAttribute("data-theme","light"),document.documentElement.classList.remove("dark"),document.body.classList.remove("dark"),()=>{document.body.style.backgroundColor=t,a?document.documentElement.setAttribute("data-theme",a):document.documentElement.removeAttribute("data-theme"),document.body.className=o}},[]),d.useEffect(()=>{async function t(){if(!f){g("Report not found."),y(!1);return}try{y(!0),g("");const a="http://localhost:5000/api".replace(/\/+$/,"");let o=await fetch(`${a}/reports/public/${f}`);if(o.status===404){const l=await fetch(`${a}/public/reports/${f}`);l.ok&&(o=l)}const i=await o.json();if(!o.ok)throw o.status===404?new Error("Report not found."):o.status===403?new Error(i.message||"This report is not available for public viewing."):new Error(i.message||"Unable to load report. Please try again.");U(i.report)}catch(a){re(a)?g(""):g(a.message||"Unable to load report.")}finally{y(!1)}}t()},[f]);const m=w.get("stamp")||w.get("stampType")||(r==null?void 0:r.stampType)||null,z=m==="lab"?ae:m==="clinic"?ie:null,O=m==="clinic"?"ETU Clinic Stamp":"ETU Lab Stamp",H=()=>{const t=window.location.href;navigator.clipboard.writeText(t),T(!0),setTimeout(()=>T(!1),3e3)},M=()=>{const t="http://localhost:5000/api".replace(/\/+$/,""),a=m?`?stampType=${m}`:"";window.open(`${t}/reports/public/${f}/pdf${a}`,"_blank")};if(F)return e.jsx("div",{style:{minHeight:"100vh",height:"auto",display:"flex",alignItems:"center",justifyContent:"center",background:"#f1f3f5",color:"#0f172a",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',padding:"16px",boxSizing:"border-box"},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{width:"48px",height:"48px",margin:"0 auto 16px",border:"4px solid #e2e8f0",borderTopColor:"#075c91",borderRadius:"50%",animation:"spin 1s linear infinite"}}),e.jsx("h2",{style:{fontSize:"1.1rem",color:"#0f172a",fontWeight:700,margin:"0 0 4px 0"},children:"Processing..."}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.85rem",margin:0},children:"Loading official diagnostic report…"})]})});if(c||!r)return e.jsx("div",{style:{minHeight:"100vh",height:"auto",display:"flex",alignItems:"center",justifyContent:"center",background:"#f1f3f5",color:"#0f172a",padding:"20px",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',boxSizing:"border-box"},children:e.jsxs("div",{style:{maxWidth:"480px",width:"100%",background:"#ffffff",borderRadius:"16px",padding:"32px 24px",boxShadow:"0 10px 25px -5px rgba(0,0,0,0.05)",textAlign:"center",border:"1px solid #cbd5e1",boxSizing:"border-box"},children:[e.jsx("div",{style:{width:"56px",height:"56px",borderRadius:"50%",background:c.includes("not available")?"#fef3c7":"#fef2f2",color:c.includes("not available")?"#d97706":"#ef4444",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px",margin:"0 auto 16px"},children:c.includes("not available")?"🔒":"⚠️"}),e.jsx("h2",{style:{fontSize:"1.25rem",color:"#0f172a",marginBottom:"8px",fontWeight:700},children:c||"Unable to load report. Please try again."}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.9rem",lineHeight:"1.5",marginBottom:"24px"},children:c.includes("not available")?"This report has not completed final administrative approval or sharing is disabled.":c.includes("not found")?"The requested report token is invalid or has been removed.":"Please check your connection or contact ETU Diagnostic Laboratory support."}),e.jsx("div",{style:{padding:"12px",background:"#f1f5f9",borderRadius:"8px",fontSize:"0.8rem",color:"#475569"},children:"🔒 ETU Diagnostic Laboratory — Official Results Portal"})]})});const n=r.patient||{},G=r.patientName||n.name||"—",$=r.patientId||n.patientId||"—",V=r.age||n.age||"—",N=r.sex||n.sex||"—",X=n.phone||"—",Y=(n.sampleTypes||[]).map(t=>(t==null?void 0:t.name)||t).filter(Boolean).join(", ")||"Specimen Assigned",_=n.collectionDate||n.createdDate||r.createdDate?new Date(n.collectionDate||n.createdDate||r.createdDate).toLocaleString():"—",R=r.approvedDate||r.approvalDate||r.reportDate?new Date(r.approvedDate||r.approvalDate||r.reportDate).toLocaleString():new Date().toLocaleString(),q=r.results||[],J=Array.isArray(r==null?void 0:r.laboratoryTests)?r.laboratoryTests:Array.isArray(n==null?void 0:n.laboratoryTests)?n.laboratoryTests:r.tests||[],k={},v={};J.forEach(t=>{var x,h;if(!t||typeof t!="object")return;const a=t.category?typeof t.category=="object"?t.category.name||"":String(t.category):t.categoryName||"",o=Array.isArray(t.parameters)&&t.parameters.length>0?typeof t.parameters[0]=="string"?t.parameters[0]:((x=t.parameters[0])==null?void 0:x.name)||((h=t.parameters[0])==null?void 0:h.sampleName):t.testName||t.name,i=u(a,o||t.testName||t.name),l=t.subcategory||"";Array.isArray(t.parameters)&&t.parameters.forEach(p=>{const S=typeof p=="string"?p:(p==null?void 0:p.name)||(p==null?void 0:p.sampleName)||"";S&&(k[S]=i,l&&(v[S]=l.toUpperCase()))});const s=t.testName||t.name||"";s&&(k[s]=i,l&&(v[s]=l.toUpperCase()))});const b=new Map;q.forEach(t=>{const a=t.parameter||t.sampleName||t.name||"",o=u(t.category||k[a],a),i=(t.subcategory||v[a]||"").toUpperCase();b.has(o)||b.set(o,new Map);const l=b.get(o),s=i||"GENERAL";l.has(s)||l.set(s,[]),l.get(s).push(t)});const A=Array.from(b.entries()).sort(([t],[a])=>{const o=C.indexOf(t),i=C.indexOf(a);return o!==-1&&i!==-1?o-i:o!==-1?-1:i!==-1?1:t.localeCompare(a)}),Q=Array.isArray(r.testInterpretations)?r.testInterpretations:[],Z=t=>{const a=u(t),o=Q.find(i=>u(i.testName)===a);return(o==null?void 0:o.interpretations)||[]};return e.jsxs("div",{className:"public-report-page",style:{minHeight:"100vh",height:"auto",width:"100%",background:"#f1f3f5",color:"#0f172a",padding:"24px 16px",fontFamily:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',boxSizing:"border-box",overflowX:"hidden",overflowY:"visible",WebkitOverflowScrolling:"touch"},children:[e.jsx("style",{children:`
        :root, html, body {
