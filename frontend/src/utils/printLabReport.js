...
function reportHtml(report, user, logoBase64, referralHospitalAddress) {
  ...
  (patient.laboratoryTests || []).forEach(t => {
    const rawCat = t?.category?.name || 'GENERAL LABORATORY';
