  ...
  try {
    ...
    const transactions = patients.map(p => {
      ...
      return {
        ...
        laboratoryTests: p.laboratoryTests || [],
        subtotal: p.subtotal || effectiveAmount,
        ...
        registeredBy: effectiveCreator,
        creatorRole: pay?.receivedBy?.role || p.registeredBy?.role || (effectiveCreator.toLowerCase().includes('admin') ? 'Admin' : 'Reception'),
