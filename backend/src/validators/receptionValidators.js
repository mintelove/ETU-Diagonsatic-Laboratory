...
export const patientSchema = z.object({
  ...
  dateOfBirth: z.preprocess(v => (v === null || v === '' || v === undefined ? null : v), z.coerce.date().nullable().optional()),
  passportNumber: z.string().trim().max(120).optional().default(''),
  passportIssueDate: z.preprocess(v => (v === null || v === '' || v === undefined ? null : v), z.coerce.date().nullable().optional()),
